// api/create-job.js
const JENKINS_URL = process.env.JENKINS_URL || "http://13.60.247.181:8080";
...
pipeline {
    ...
    environment {
        SONAR_HOST_URL = 'http://13.50.16.248:9000'
        SONAR_AUTH_TOKEN = credentials('sonarqube')
        MONGO_URI = 'ec2-51-21-196-160.eu-north-1.compute.amazonaws.com:27017'
        MONGO_DB = 'SDP_2026'
